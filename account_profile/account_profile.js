...
$( document ).ready( () => {
    ...
    $( "#save" ).click( () => {
        ...
        /* Add another line of code that defines a regular expression pattern
        ...
        /* Add an if statement that checks whether the user entered 
           something for the credit card */
