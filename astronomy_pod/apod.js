...
$(document).ready( () => {
    ...
    /* Add the async keyword to the click() event handler for the View button */
    $("#view_button").click( async () => {
        ...
        if (dateObj == "Invalid Date") {
            ...
            /* code a try/catch statement so that the try block contains 
               the chain of promises */
            try {
                /* In the try block, code the await keyword  */
