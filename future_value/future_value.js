...
$(document).ready( () => {
    $("#calculate").click( () => {
        ...
        if (isNaN(rate) || rate <= 0 || rate > 15) {
            $("#rate").next().text("Number must be valid and greater than 0 and less than or equal to 15.")
            isValid = false;
        } 
        else {
            $("#rate").next().text("");
        ...
        if (isNaN(years) || years <= 0 || years > 50) {
            $("#years").next().text("Number must be valid and greater than 0 and less than or equal to 50.")
            isValid = false;
        } 
        else {
            $("#years").next().text("");
