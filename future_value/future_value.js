...
const calculateFutureValue = (investment, rate, years) => {
    ...
    for (let i = 1; i <= years; i++ ) {
        ...
        /* Modify the JavaScript by adding an if statement to the for loop 
    ...
    /* Add an alert() method that displays the maximum value of a JavaScript 
       number after the for loop finishes */
